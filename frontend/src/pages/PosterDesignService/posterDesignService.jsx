...
export default function PosterDesignService() {
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="flex gap-20 justify-center xl:px-20 lg:px-10 px-3 lg:mt-16 mt-10">
        <div className="flex-1 sticky top-32 left-0 h-fit bg-brown-100 rounded-md p-5">
          <StepToOrder />
        </div>
        <div className="bg-white rounded-md shadow-lg w-[560px]">
          <div className="p-10">
          ...
          <div className="mt-10 flex gap-[5px] p-3">
